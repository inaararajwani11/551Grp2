...
We will be using Dash for building the dashboard in both R and Python, together with the visualization libraries you learnt in 531 to create effective data visualizations that strengthen our own exploratory data analysis skills and our ability to communicate insights to others.
...
4. Implement interactive visualizations and dashboard components using Plotly's Dash, ggplotly and Altair.
5. Use Heroku or other platforms to deploy interactive dashboards publicly.
...
**Lectures**: Tuesday and Thursday, 09:30-11:00.

**Labs**: Tuesday 1:30 to 3:30 p.m.

## Teaching Team

TA: NARBAYEV, BAKDAUREN (bakdauren.narbayev@ubc.ca)
...
|-----------------|--------|---------------------|-----------------|
| Milestone 1  (Group)   | 10%    | 2026-02-13 19:00 PT | Github & Canvas |
| Milestone 2   (Group)  | 20%    | 2026-02-27 19:00 PT | Github & Canvas |
| Milestone 3  (Group)   | 20%    | 2026-03-06 19:00 PT | Github & Canvas |
| Milestone 4  (Group)   | 30%    | 2026-03-13 19:00 PT | Github & Canvas |
| Team reflection (Individual)| 10%    | 2026-03-19 23:59 PT | Canvas          |
| Peer review    (Individual) | 10%    | 2026-03-19 23:59 PT | Canvas          |


__Tentative Lecture Details__ (Warning, subject to change!):
...
| 3 | Principles of effective dashboard design & Deploying your app | <ul> <li> Principles of effective dashboard design </ul>
...
| 8 | Dashboard awards & Review of effective dashboards | <ul> <li> Linked Charts in DashR <li> Good practices in dashboards <li> Take-home viz messages </ul>


__Lab Details__:

Lab time will be used towards the projects. 

| Lab | Topic |
|-----|-------|
| 1 | Teams, Basic GitHub, Creating Code of Conduct and Team Contract, Dash app |
| 2 | Advanced GitHub & Deploying app, Dash app |
| 3 | Peer Feedback |
| 4 | Deploying app |
